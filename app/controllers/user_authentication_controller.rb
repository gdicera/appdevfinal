class UserAuthenticationController < ApplicationController
  ...
  def create_cookie
    ...
    if user != nil
      ...
      if are_they_legit == false
        ...
        redirect_to("/topics", { :notice => "Signed in successfully." })
      end
    else
  ...
  def destroy_cookies
    ...
    redirect_to("/user_sign_out", { :notice => "Signed out successfully." })
  end
  ...
  def create
    ...
    if save_status == true
      ...
      redirect_to("/topics", { :notice => "User account created successfully."})
    else
